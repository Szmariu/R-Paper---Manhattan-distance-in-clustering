...
The conclusions for this experiments are not straightforward. The synthetic benchmark - distance matrices, showed that using a manhattan distance metric can lead to a performance increase of around **10%**. This positive effect was also present when using the Clara algorithm, although to a smaller extent (around **3.5%**). On the contrary, in CClust the use of manhattan distance led to a slowdown of about **7.50%**.   
